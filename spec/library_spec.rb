...
describe 'Library Object' do
    before(:all) do
        lib_obj = []
        lib_obj << BookHelper::Book.new('JavaScript: The Good Parts', 'Douglas Crockford', :development)
        lib_obj << BookHelper::Book.new('Designing with Web Standards', 'Jeffrey Zeldman', :design)
        lib_obj << BookHelper::Book.new("Don't Make me Think", 'Steve Krug', :usability)
        lib_obj << BookHelper::Book.new('JavaScript Patterns', 'Stoyan Stefanov', :development)
        lib_obj << BookHelper::Book.new('Responsive Web Design', 'Ethan Marcotte', :design)
    ...
    it 'accepts new book' do
        @lib.add_book(BookHelper::Book.new('Designing for the Web', 'Mark Boulton', :design))
